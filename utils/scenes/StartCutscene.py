...
class StartCutscene:
    ...
    def play(self, dt: float, tool_bar: ToolBar, display: pygame.Surface, mouse_pos: tuple,
        ...
        if self.text_2_char >= 0 and self.text_2_begun and self.text == 2 or self.text == 3:
            display.blit(self.dialog_box, (0, 0))
            display.blit(pygame.font.Font.render(self.font, self.text_2[0:self.text_2_char], False, (255, 255, 255)), (3, 120))
        ...
        if self.text_3_char >= 0 and self.text_3_begun and self.text == 3:
            display.blit(pygame.font.Font.render(self.font, self.text_3[0:self.text_3_char], False, (255, 255, 255)), (3, 137))
        ...
        if self.text_4_char >= 0 and self.text_4_begun and self.text == 4 or self.text == 5:
            display.blit(self.dialog_box, (0, 0))
            display.blit(pygame.font.Font.render(self.font, self.text_4[0:self.text_4_char], False, (255, 255, 255)), (3, 120))
        ...
        if self.text_5_char >= 0 and self.text_5_begun and self.text == 5:
            display.blit(pygame.font.Font.render(self.font, self.text_5[0:self.text_5_char], False, (255, 255, 255)), (3, 137))
        ...
        if self.text_6_char >= 0 and self.text_6_begun and self.text == 6 or self.text == 7:
            display.blit(self.dialog_box, (0, 0))
            display.blit(pygame.font.Font.render(self.font, self.text_6[0:self.text_6_char], False, (255, 255, 255)), (3, 120))
        ...
        if self.text_7_char >= 0 and self.text_7_begun and self.text == 7:
            display.blit(pygame.font.Font.render(self.font, self.text_7[0:self.text_7_char], False, (255, 255, 255)), (3, 137))
        ...
        if self.text_8_char >= 0 and self.text_8_begun and self.text == 8 or self.text == 9:
            display.blit(self.dialog_box, (0, 0))
            display.blit(pygame.font.Font.render(self.font, self.text_8[0:self.text_8_char], False, (255, 255, 255)), (3, 120))
        ...
        if self.text_9_char >= 0 and self.text_9_begun and self.text == 9:
            display.blit(pygame.font.Font.render(self.font, self.text_9[0:self.text_9_char], False, (255, 255, 255)), (3, 137))
        ...
        if self.text_10_char >= 0 and self.text_10_begun and self.text == 10 or self.text == 11:
            display.blit(self.dialog_box, (0, 0))
            display.blit(pygame.font.Font.render(self.font, self.text_10[0:self.text_10_char], False, (255, 255, 255)), (3, 120))
        ...
        if self.text_11_char >= 0 and self.text_11_begun and self.text == 11:
            display.blit(pygame.font.Font.render(self.font, self.text_11[0:self.text_11_char], False, (255, 255, 255)), (3, 137))
        ...
        if self.text_12_char >= 0 and self.text_12_begun and self.text == 12 or self.text == 13:
            display.blit(self.dialog_box, (0, 0))
            display.blit(pygame.font.Font.render(self.font, self.text_12[0:self.text_12_char], False, (255, 255, 255)), (3, 120))
        ...
        if self.text_13_char >= 0 and self.text_13_begun and self.text == 13:
            display.blit(pygame.font.Font.render(self.font, self.text_13[0:self.text_13_char], False, (255, 255, 255)), (3, 137))
        ...
        if self.text_14_char >= 0 and self.text_14_begun and self.text == 14 or self.text == 15:
            display.blit(self.dialog_box, (0, 0))
            display.blit(pygame.font.Font.render(self.font, self.text_14[0:self.text_14_char], False, (255, 255, 255)), (3, 120))
        ...
        if self.text_15_char >= 0 and self.text_15_begun and self.text == 15:
            display.blit(pygame.font.Font.render(self.font, self.text_15[0:self.text_15_char], False, (255, 255, 255)), (3, 137))
        ...
        if self.text_16_char >= 0 and self.text_16_begun and self.text == 16 or self.text == 17:
            display.blit(self.dialog_box, (0, 0))
            display.blit(pygame.font.Font.render(self.font, self.text_16[0:self.text_16_char], False, (255, 255, 255)), (3, 120))
        ...
        if self.text_17_char >= 0 and self.text_17_begun and self.text == 17:
            display.blit(pygame.font.Font.render(self.font, self.text_17[0:self.text_17_char], False, (255, 255, 255)), (3, 137))
        ...
        if self.text_18_char >= 0 and self.text_18_begun and self.text == 18 or self.text == 19:
            display.blit(self.dialog_box, (0, 0))
            display.blit(pygame.font.Font.render(self.font, self.text_18[0:self.text_18_char], False, (255, 255, 255)), (3, 120))
        ...
        if self.text_19_char >= 0 and self.text_19_begun and self.text == 19:
            display.blit(pygame.font.Font.render(self.font, self.text_19[0:self.text_19_char], False, (255, 255, 255)), (3, 137))
        ...
        if self.text_20_char >= 0 and self.text_20_begun and self.text == 20 or self.text == 21:
            display.blit(self.dialog_box, (0, 0))
            display.blit(pygame.font.Font.render(self.font, self.text_20[0:self.text_20_char], False, (255, 255, 255)), (3, 120))
        ...
        if self.text_21_char >= 0 and self.text_21_begun and self.text == 21:
            display.blit(pygame.font.Font.render(self.font, self.text_21[0:self.text_21_char], False, (255, 255, 255)), (3, 137))
        ...
        if self.text_22_char >= 0 and self.text_22_begun and self.text == 22 or self.text == 23:
            display.blit(self.dialog_box, (0, 0))
            display.blit(pygame.font.Font.render(self.font, self.text_22[0:self.text_22_char], False, (255, 255, 255)), (3, 120))
        ...
        if self.text_23_char >= 0 and self.text_23_begun and self.text == 23:
            display.blit(pygame.font.Font.render(self.font, self.text_23[0:self.text_23_char], False, (255, 255, 255)), (3, 137))
