...
def main():
    ...
    scenes = [utils.scenes.MainMenu(display), utils.scenes.CableScene(tool_bar, display), utils.scenes.FuelScene(tool_bar), utils.scenes.ConveyorBeltScene(display), utils.scenes.WeldingScene(tool_bar, display)]
